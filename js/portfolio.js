...
//	$(".penart-2").css("margin-left", "0px");

	for(var i = 3; i < 7; i++) {

		if(document.querySelector(".penart-" + i).style.display === "none") {

			document.querySelector(".penart-" + i).style.display = "block";

			document.querySelector(".penart-2").style.marginRight = "0px";
			...
			document.querySelector(".penart-" + i).style.display = "none";
//			document.querySelector(".penart-2").style.marginRight = "90px";
	...
	for(var i = 3; i < 7; i++) {
		...
		if(document.querySelector(".penart-" + i).style.display === "none") {
			...
			document.querySelector(".penart-2").style.marginLeft = "0px";
			...
			document.querySelector(".penart-" + i).style.display = "none";
						...
						document.querySelector(".penart-2").style.marginLeft = "60px";
